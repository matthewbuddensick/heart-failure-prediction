...
In this notebook I will be going through a dataset I found on [kaggle](https://www.kaggle.com/andrewmvd/heart-failure-clinical-data) to predict heart failure. It can also be found on the [UCI Machine Learning Repository](https://archive.ics.uci.edu/ml/datasets/Heart+failure+clinical+records).
...
Below is a function to creat a workflow object. It takes in a recipe in a model and creaters an object that aggregates information in order to fit and predict from a model.
